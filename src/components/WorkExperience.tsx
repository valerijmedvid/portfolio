...
const Experiences: ExperienceList = [
  {
    ...
    link: 'https://www.kb.cz/',
    period: { start: new Date('2024-01-01'), end: null },
    description: 'TS · Tribe · Git · JavaScript · Vue',
  },
  {
    company: 'Košík s.r.o.',
    position: 'Frontend developer',
    link: 'https://www.kosik.cz/',
    period: { start: new Date('2022-06-01'), end: new Date('2023-12-31') },
    description: 'Scrum · Komunikace · SQL · Git · JavaScript · Vue · Docker',
  },
  {
    company: 'Avast s.r.o.',
    position: 'Software Engineer',
    link: 'https://www.avast.com/',
    period: { start: new Date('2019-03-01'), end: new Date('2022-05-31') },
  ...
  },
  {
    ...
    link: 'https://www.avast.com/',
    period: { start: new Date('2012-10-01'), end: new Date('2019-02-28') },
  ...
  },
  {
    ...
    period: { start: new Date('2011-10-01'), end: new Date('2012-09-30') },
    description:
  ...
  return (
    <div className='m-12 font-sans text-center'>
      ...
      {Experiences.map((experience, index) => (
        <article key={`${index}-${experience.company}`} className='mb-8'>
          ...
          <p className='text-gray-500'>
            ...
            {experience.period.end ? experience.period.end.getFullYear() : 'now'}
          </p>
